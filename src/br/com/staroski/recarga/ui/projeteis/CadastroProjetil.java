package br.com.staroski.recarga.ui.projeteis;
...
public final class CadastroProjetil extends JDialog {
	...
	private void salvar() {
		...
		if (opcao == JOptionPane.YES_OPTION) {
			try {
				projetil.setDescricao(textFieldDescricao.getText().trim());
				projetil.setQuantidade(parseInt(textFieldQuantidade.getText()));
				Database.get().save(projetil);
				dispose();
			} catch (Exception e) {
				showError(this, e);
			}
	...
	public CadastroProjetil(Projetil projetil) {
		this();
		this.projetil = projetil;
		textFieldDescricao.setText(projetil.getDescricao());
		textFieldQuantidade.setText(String.valueOf(projetil.getQuantidade()));
	}
